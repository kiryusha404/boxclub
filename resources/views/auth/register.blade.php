            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="tel" class="col-md-4 col-form-label text-md-end">{{ __('Номер телефона') }}</label>

                            <div class="col-md-6">
                                <input id="tel" type="text" class="form-control @error('tel') is-invalid @enderror tel" name="tel" value="{{ old('tel') }}" required autocomplete="tel">
                            ...
                            <div class="col-md-6 offset-md-4">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="remember">
                                        <p>Я соглащаюсь с <a href="{{route('license')}}">условиями сайта</a></p>
                                    </label>
                                </div>
                            </div>
                        </div>
